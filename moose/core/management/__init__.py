...
def get_commands():
    ...
    This works by looking for a management.commands package in moose.core, and
    ...
    calls.
    """
    commands = {name: 'moose.core' for name in find_commands(upath(__path__[0]))}
...
class ManagementUtility(object):
    ...
    def fetch_command(self, subcommand):
        ...
        try:
            ...
            if os.environ.get('MOOSE_SETTINGS_MODULE'):
                ...
                sys.stderr.write("No Moose settings specified.\n")
            sys.stderr.write(
    ...
    def autocomplete(self):
        ...
        if 'MOOSE_AUTO_COMPLETE' not in os.environ:
            return
    ...
    def execute(self):
        ...
        # 'django-admin --help' to work, for backwards compatibility.
            ...
            sys.stdout.write(moose.get_version() + '\n')
